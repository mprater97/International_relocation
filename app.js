...
function movePlanHouses(){
  ...
  var bmCode="javascript:void(navigator.clipboard.writeText(location.href).then(function(){alert(String.fromCharCode(10004)+String.fromCharCode(32)+String.fromCharCode(67)+String.fromCharCode(111)+String.fromCharCode(112)+String.fromCharCode(105)+String.fromCharCode(101)+String.fromCharCode(100)+String.fromCharCode(33))}).catch(function(){prompt(String.fromCharCode(67)+String.fromCharCode(111)+String.fromCharCode(112)+String.fromCharCode(121)+String.fromCharCode(58),location.href)}))";
  ...
  html+='<p class="tx tm" style="font-size:.65rem;margin-top:6px"><strong>To use:</strong> On a Domain listing → tap bookmark → URL is copied → switch to tracker → paste in URL field above → address + suburb auto-fill.</p>';
  html+='</div>';
