...
const FORECAST_ITEMS = [
  ...
  {id:'sep_car',type:'oneoff',defaultFund:'sale_proceeds',cat:'AU Car',desc:'Car purchase (used, reliable family car)',week:15,forecastLow:6000,forecastHigh:10000,forecast:8000,phase:4,defaultFund:'lump_sum'},
  {id:'au_car_rego',type:'oneoff',cat:'AU Car',desc:'Registration transfer / new rego',week:15,forecastLow:400,forecastHigh:800,forecast:600,phase:4,defaultFund:'lump_sum'},
  {id:'au_car_ins',type:'oneoff',cat:'AU Car',desc:'Car insurance (first year)',week:15,forecastLow:1200,forecastHigh:2000,forecast:1600,phase:4,defaultFund:'lump_sum'},
  {id:'au_car_rwc',type:'oneoff',cat:'AU Car',desc:'Roadworthy certificate (RWC)',week:15,forecastLow:100,forecastHigh:200,forecast:150,phase:4,defaultFund:'lump_sum'},
  {id:'au_car_service',type:'oneoff',cat:'AU Car',desc:'Initial service / inspection',week:15,forecastLow:200,forecastHigh:400,forecast:300,phase:4,defaultFund:'lump_sum'},
  {id:'au_car_racv',type:'oneoff',cat:'AU Car',desc:'RACV roadside assist (annual)',week:15,forecastLow:100,forecastHigh:150,forecast:125,phase:4,defaultFund:'lump_sum'},
  {id:'au_car_toll',type:'oneoff',cat:'AU Car',desc:'CityLink / EastLink toll account setup',week:15,forecastLow:0,forecastHigh:50,forecast:25,phase:4,defaultFund:'lump_sum'},
  {id:'au_car_seats',type:'oneoff',cat:'AU Car',desc:'Roof racks / boot organiser / accessories',week:16,forecastLow:100,forecastHigh:300,forecast:200,phase:4,defaultFund:'lump_sum'},
