...
const FORECAST_ITEMS = [
  ...
  {id:'repairs',type:'oneoff',cat:'UK Property',desc:'Repairs & defects',week:6,forecastLow:200,forecastHigh:1000,forecast:500,phase:2,defaultFund:'lump_sum'},
  {id:'paint',type:'oneoff',cat:'UK Property',desc:'Paint touch-up',week:6,forecastLow:50,forecastHigh:200,forecast:80,phase:2,defaultFund:'lump_sum'},
  {id:'clean',type:'oneoff',cat:'UK Property',desc:'Professional deep clean',week:7,forecastLow:150,forecastHigh:300,forecast:200,phase:2,defaultFund:'lump_sum'},
  {id:'photos',type:'oneoff',cat:'UK Property',desc:'Professional photos',week:7,forecastLow:100,forecastHigh:200,forecast:150,phase:2,defaultFund:'lump_sum'},
  ...
  {id:'agent_fee',type:'oneoff',cat:'UK Property',desc:'Letting agent setup fee (LAP - inc photos & marketing)',week:4,forecastLow:358,forecastHigh:358,forecast:358,phase:1,defaultFund:'lump_sum'},
  {id:'agent_plan',type:'monthly',cat:'UK Property',desc:'Letting agent annual plan (LAP - save 10%)',week:4,forecastLow:1177,forecastHigh:1308,forecast:1177,phase:1,defaultFund:'lump_sum'},
  {id:'skip',type:'oneoff',cat:'Declutter',desc:'Skip / bulk waste',week:2,forecastLow:150,forecastHigh:300,forecast:200,phase:1,defaultFund:'lump_sum'},
  {id:'fx_cost',type:'oneoff',cat:'Financial',desc:'FX conversion costs',week:3,forecastLow:300,forecastHigh:600,forecast:400,phase:1,defaultFund:'lump_sum'},
  {id:'mail_redirect',type:'oneoff',cat:'UK Exit',desc:'Royal Mail redirect 12mo',week:8,forecastLow:60,forecastHigh:100,forecast:80,phase:2,defaultFund:'lump_sum'},
  {id:'misc_exit',type:'oneoff',cat:'UK Exit',desc:'Misc UK exit costs',week:11,forecastLow:100,forecastHigh:300,forecast:200,phase:3,defaultFund:'lump_sum'},
  {id:'poa',type:'oneoff',cat:'Legal',desc:'UK Power of Attorney',week:7,forecastLow:100,forecastHigh:300,forecast:200,phase:2,defaultFund:'lump_sum'},
  ...
  {id:'au_school1',type:'oneoff',cat:'AU School',desc:'School fees — 14yr old (term)',week:14,forecastLow:1250,forecastHigh:3000,forecast:2000,phase:4,defaultFund:'lump_sum'},
  {id:'au_school2',type:'oneoff',cat:'AU School',desc:'School fees — 10yr old (term)',week:14,forecastLow:1250,forecastHigh:3000,forecast:2000,phase:4,defaultFund:'lump_sum'},
  ...
  {id:'au_health',type:'monthly',cat:'AU Insurance',desc:'Health insurance (3 months)',week:13,forecastLow:800,forecastHigh:1500,forecast:1100,phase:4,defaultFund:'lump_sum'},
...
const MONTHLY_AU = [
  ...
  {id:'m_eat',desc:'Eating out / coffees / takeaway',monthly_aud:250},
  {id:'m_fuel',desc:'Car fuel',monthly_aud:250},
  {id:'m_car_ins',desc:'Car insurance',monthly_aud:150},
  {id:'m_car_rego',desc:'Car rego + maintenance (amortised)',monthly_aud:80},
  {id:'m_car_lease',desc:'Car lease OR loan repayment (if not buying outright)',monthly_aud:0},
  ...
  {id:'m_school',desc:'School uniforms / books / excursions (amortised)',monthly_aud:60},
