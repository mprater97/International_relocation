...
function showSuburbDetail(name){
  ...
  var disposable=9571-bed4mo-3905;
...
function renderSuburbsInteractive(){
  ...
  tiers.forEach(function(tier){
    ...
    tier.suburbs.forEach(function(sname){
      ...
      var disposable=9571-rentMo-3905; // 3905 = monthly costs excl rent
...
CMP.costs='<div class="card" style="border-left:4px solid var(--accent);margin-bottom:12px"><div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px"><div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap"><div><div class="tm" style="font-size:.7rem">Net Salary</div><div style="font-size:1.1rem;font-weight:700;color:var(--green)">$9,571 (£5,092)/mo</div></div><div style="font-size:1.2rem;color:var(--muted)">−</div><div><div class="tm" style="font-size:.7rem">Living Costs (excl. rent)</div><div style="font-size:1.1rem;font-weight:700;color:var(--orange)">$3,905 (£2,077)/mo</div></div><div style="font-size:1.2rem;color:var(--muted)">=</div><div><div class="tm" style="font-size:.7rem">Before Rent</div><div style="font-size:1.1rem;font-weight:700;color:var(--green)">$5,666 (£3,014)/mo</div><div class="tm" style="font-size:.65rem">Subtract your suburb\'s rent for final disposable</div></div></div><button class="btn btn-o" style="font-size:.7rem;padding:6px 10px" onclick="document.getElementById(\'lcPopup\').style.display=document.getElementById(\'lcPopup\').style.display===\'block\'?\'none\':\'block\'">📋 What\'s included?</button></div><div id="lcPopup" style="display:none;margin-top:12px;font-size:.78rem;max-height:350px;overflow-y:auto"><div style="font-weight:600;margin-bottom:6px">Monthly expenses (excluding rent):</div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Groceries</span><span>$1,400 (£745)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Eating out / coffees / takeaway</span><span>$250 (£133)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Car fuel</span><span>$250 (£133)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Car lease (inc. insurance, rego, maint)</span><span>$600 (£319)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Electricity + gas</span><span>$250 (£133)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Water usage</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Internet (NBN)</span><span>$80 (£43)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Health insurance (your 20%)</span><span>$80 (£43)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Mobile phones (family)</span><span>$130 (£69)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Streaming (Netflix, Spotify)</span><span>$35 (£19)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Contents / rental insurance</span><span>$40 (£21)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Kids activities</span><span>$300 (£160)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>School uniforms / books</span><span>$60 (£32)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Clothing / shoes</span><span>$120 (£64)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Haircuts / personal care</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Medical / dental gap</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Pet insurance + vet</span><span>$60 (£32)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Household supplies</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>School contributions (x2)</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;font-weight:700"><span>TOTAL (excl. rent)</span><span>$3,905 (£2,077)/mo</span></div><div class="tm" style="font-size:.7rem;margin-top:4px">⬆️ Subtract your chosen suburb\'s rent from $5,666 to get your final monthly disposable income.</div></div></div>'+
'<div class="card"><h2>💰 Monthly Budget — $159k (£85k) Salary (4-Bed with Garden)</h2><p class="tx tm mb2">Net: $9,571 (£5,092)/mo. Amazon pays 80% health insurance.</p><div class="table-wrap"><table><tr><th>Suburb</th><th>4-bed/wk</th><th>Rent/mo</th><th>Disposable/mo</th><th>Disposable/yr</th></tr><tr style="background:rgba(34,197,94,.05)"><td style="font-weight:600"><a href="https://www.google.com/maps/search/Langwarrin+Victoria+Australia/@-38.1670,145.1700,13z" target="_blank" style="color:var(--accent)">Langwarrin 📍</a></td><td>$590 (£314)</td><td>$2,556 (£1360)</td><td style="color:var(--green)">$3,110 (£1655)</td><td style="color:var(--green)">$37,320 (£19854)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Seaford+Victoria+Australia/@-38.1000,145.1340,13z" target="_blank" style="color:var(--accent)">Seaford 📍</a></td><td>$620 (£330)</td><td>$2,686 (£1429)</td><td style="color:var(--green)">$2,980 (£1585)</td><td style="color:var(--green)">$35,760 (£19024)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Frankston+Victoria+Australia/@-38.1430,145.1260,13z" target="_blank" style="color:var(--accent)">Frankston 📍</a></td><td>$630 (£335)</td><td>$2,730 (£1452)</td><td style="color:var(--green)">$2,936 (£1562)</td><td style="color:var(--green)">$35,232 (£18743)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Mordialloc+Victoria+Australia/@-37.9870,145.0870,13z" target="_blank" style="color:var(--accent)">Mordialloc 📍</a></td><td>$730 (£388)</td><td>$3,163 (£1683)</td><td style="color:var(--green)">$2,503 (£1332)</td><td style="color:var(--green)">$30,036 (£15979)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Mentone+Victoria+Australia/@-37.9830,145.0670,13z" target="_blank" style="color:var(--accent)">Mentone 📍</a></td><td>$800 (£426)</td><td>$3,466 (£1844)</td><td style="color:var(--green)">$2,200 (£1170)</td><td style="color:var(--green)">$26,400 (£14045)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Glen Waverley+Victoria+Australia/@-37.8780,145.1630,13z" target="_blank" style="color:var(--accent)">Glen Waverley 📍</a></td><td>$900 (£479)</td><td>$3,553 (£1890)</td><td style="color:var(--green)">$2,113 (£1124)</td><td style="color:var(--green)">$25,356 (£13489)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Sandringham+Victoria+Australia/@-37.9510,145.0100,13z" target="_blank" style="color:var(--accent)">Sandringham 📍</a></td><td>$950 (£505)</td><td>$4,116 (£2190)</td><td style="color:var(--orange)">$1,550 (£825)</td><td style="color:var(--orange)">$18,600 (£9895)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Brighton+Victoria+Australia/@-37.9070,144.9870,13z" target="_blank" style="color:var(--accent)">Brighton 📍</a></td><td>$1100 (£585)</td><td>$4,766 (£2536)</td><td style="color:var(--orange)">$900 (£479)</td><td style="color:var(--orange)">$10,800 (£5746)</td></tr></table></div></div>';
