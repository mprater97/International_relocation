...
+'<tr><td style="font-weight:600"><a href="https://www.mentonegirls.vic.edu.au" target="_blank" style="color:var(--accent)">Mentone Girls SC →</a></td><td>Mentone</td><td style="font-weight:700;color:var(--green)">31</td><td>~900</td><td>⭐⭐⭐⭐</td><td>⭐⭐⭐⭐⭐</td><td>⭐⭐⭐</td><td>Bella</td><td>Drama/dance focus, annual musical, sports teams, wellbeing focus, creative arts. Girls only.</td></tr>'
...
+'<div class="card"><h2>🏆 Our Recommendation</h2><div class="table-wrap"><table><tr><th></th><th>Bella (Yr 9–10)</th><th>Jack (Yr 7–8)</th></tr>'
+'<tr><td style="font-weight:600">1st Choice</td><td style="color:var(--green)"><strong>Parkdale SC</strong> — sports + drama + outdoor ed. VCE 30.</td><td style="color:var(--green)"><strong>Parkdale SC</strong> — sports academy + hands-on + outdoor camps. VCE 30.</td></tr>'
+'<tr><td style="font-weight:600">2nd Choice</td><td><strong>Sandringham College</strong> — elite performing arts + beach. VCE 30.</td><td><strong>Frankston High</strong> — sports focus + outdoor ed + big school energy. VCE 28.</td></tr>'
+'<tr><td style="font-weight:600">3rd Choice</td><td><strong>Mentone Girls</strong> — drama/dance + wellbeing. VCE 31. (girls only)</td><td><strong>Elisabeth Murdoch</strong> — outdoor ed + environment + camps. VCE 27.</td></tr>'
+'</table></div>'
+'<p class="ts mt2">💡 <strong>Catchment matters:</strong> VIC public schools use catchment zones. Living in Mordialloc/Parkdale/Aspendale puts you in Parkdale SC catchment — our top pick for both kids. Use <a href="https://www.findmyschool.vic.gov.au" target="_blank" style="color:var(--accent)">findmyschool.vic.gov.au</a> to check zones.</p>'
