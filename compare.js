...
+'<tr><td style="font-weight:600"><a href="https://www.mcclellandcollege.vic.edu.au" target="_blank" style="color:var(--accent)">McClelland College →</a></td><td>Frankston Sth</td><td>26</td><td>~900</td><td>3/5</td><td>5/5</td><td>4/5</td><td>5/5</td><td>Dedicated Performing Arts Academy, outdoor camps, VET pathways, visual arts</td></tr>'
...
+'<tr style="background:rgba(34,197,94,.05)"><td style="font-weight:600"><a href="https://www.carrumps.vic.edu.au" target="_blank" style="color:var(--accent)">Carrum Primary →</a></td><td>Carrum</td><td style="color:var(--green)">Patterson River SC ✓</td><td>~300</td><td>Beach community, outdoor focus, small & nurturing, feeds directly into Patterson River SC</td></tr>'
+'<tr><td style="font-weight:600"><a href="https://www.bonbeachps.vic.edu.au" target="_blank" style="color:var(--accent)">Bonbeach Primary →</a></td><td>Bonbeach</td><td style="color:var(--green)">Patterson River SC ✓</td><td>~250</td><td>Small school, beach lifestyle, community feel, also feeds into Patterson River SC</td></tr>'
+'</table></div>'
...
+'<div class="card" style="border-left:4px solid var(--green)"><h3>⭐ Patterson River Secondary College</h3><p class="tx tm">Carrum | ~950 students | VCE 26</p>'
+'<h4>🏅 Sports</h4><div class="tx" style="line-height:2">AFL · Netball · Soccer · Basketball · Swimming · Athletics · Cross country · Surfing · Kayaking · Sailing · Beach sports · Interschool sport program</div>'
+'<h4>🎭 Drama & Arts</h4><div class="tx" style="line-height:2">Annual school musical · Drama classes Yr 7–12 · Dance program · Music ensembles (band, choir) · Visual arts · Media studies · Photography</div>'
+'<h4>⛺ Outdoor Education</h4><div class="tx" style="line-height:2">Outstanding outdoor ed program (school backs onto Patterson River) · Kayaking · Surfing · Sailing · Marine studies · Year level camps · VCE Outdoor & Environmental Studies · Bushwalking · Rock climbing · Snorkelling · Beach access (2 min walk) · River ecology projects</div>'
+'<h4>🏢 Facilities</h4><div class="tx" style="line-height:2">Direct river access (kayak launch) · Performing arts centre · Gymnasium · Ovals · Courts · Science labs · Art studios · Tech workshops · 2 min walk to Carrum beach · Near Patterson River boat ramp</div>'
+'<h4>🌏 International Students</h4><div class="tx" style="line-height:2">Experienced with international enrolments · EAL support · Buddy program · Transition coordinator · Wellbeing team · Inclusive community</div>'
+'<h4>🎯 Extracurriculars</h4><div class="tx" style="line-height:2">Kayak club · Surf club · Environment club · Coding club · Music rehearsals · Art club · Leadership programs · Lunchtime sports · Community service · Duke of Edinburgh</div>'
+'<p class="ts mt2" style="color:var(--green)">✅ <strong>Why it stands out:</strong> The school literally sits on Patterson River with beach 2 min walk. Outdoor ed is exceptional — kayaking, surfing, marine studies built into the curriculum. Great for active kids who love water/outdoors. Smaller than Parkdale but more intimate community feel. Catchment: Carrum, Seaford (parts), Bonbeach.</p></div>'
