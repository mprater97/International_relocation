...
CMP.costs='<div class="card" style="border-left:4px solid var(--accent);margin-bottom:12px"><div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px"><div style="display:flex;align-items:center;gap:16px;flex-wrap:wrap"><div><div class="tm" style="font-size:.7rem">Net Salary</div><div style="font-size:1.1rem;font-weight:700;color:var(--green)">$9,571 (£5,092)/mo</div></div><div style="font-size:1.2rem;color:var(--muted)">−</div><div><div class="tm" style="font-size:.7rem">Living Costs (excl. rent)</div><div style="font-size:1.1rem;font-weight:700;color:var(--orange)">$4,115 (£2,189)/mo</div></div><div style="font-size:1.2rem;color:var(--muted)">=</div><div><div class="tm" style="font-size:.7rem">Before Rent</div><div style="font-size:1.1rem;font-weight:700;color:var(--green)">$5,456 (£2,903)/mo</div><div class="tm" style="font-size:.65rem">Subtract your suburb\'s rent for final disposable</div></div></div><button class="btn btn-o" style="font-size:.7rem;padding:6px 10px" onclick="document.getElementById(\'lcPopup\').style.display=document.getElementById(\'lcPopup\').style.display===\'block\'?\'none\':\'block\'">📋 What\'s included?</button></div><div id="lcPopup" style="display:none;margin-top:12px;font-size:.78rem;max-height:350px;overflow-y:auto"><div style="font-weight:600;margin-bottom:6px">Monthly expenses (excluding rent):</div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Groceries</span><span>$1,400 (£745)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Eating out / coffees / takeaway</span><span>$250 (£133)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Car fuel</span><span>$250 (£133)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Car insurance</span><span>$150 (£80)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Car rego + maintenance</span><span>$80 (£43)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Car lease (monthly)</span><span>$500 (£266)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Electricity + gas</span><span>$250 (£133)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Water usage</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Internet (NBN)</span><span>$80 (£43)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Health insurance (your 20%)</span><span>$80 (£43)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Mobile phones (family)</span><span>$130 (£69)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Streaming (Netflix, Spotify)</span><span>$35 (£19)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Contents / rental insurance</span><span>$40 (£21)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Kids activities</span><span>$300 (£160)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>School uniforms / books</span><span>$60 (£32)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Clothing / shoes</span><span>$120 (£64)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Haircuts / personal care</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Medical / dental gap</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Gifts / birthdays / parties</span><span>$80 (£43)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Pet insurance + vet</span><span>$60 (£32)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>Household supplies</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid var(--border)"><span>School contributions (x2)</span><span>$50 (£27)</span></div><div style="display:flex;justify-content:space-between;padding:6px 0;font-weight:700"><span>TOTAL (excl. rent)</span><span>$4,115 (£2,189)/mo</span></div><div class="tm" style="font-size:.7rem;margin-top:4px">⬆️ Subtract your chosen suburb\'s rent from $5,456 to get your final monthly disposable income.</div></div></div>'+
'<div class="card"><h2>💰 Monthly Budget — $159k (£85k) Salary (4-Bed with Garden)</h2><p class="tx tm mb2">Net: $9,571 (£5,092)/mo. Amazon pays 80% health insurance.</p><div class="table-wrap"><table><tr><th>Suburb</th><th>4-bed/wk</th><th>Rent/mo</th><th>Disposable/mo</th><th>Disposable/yr</th></tr><tr style="background:rgba(34,197,94,.05)"><td style="font-weight:600"><a href="https://www.google.com/maps/search/Langwarrin+Victoria+Australia/@-38.1670,145.1700,13z" target="_blank" style="color:var(--accent)">Langwarrin 📍</a></td><td>$590 (£314)</td><td>$2,556 (£1360)</td><td style="color:var(--green)">$4,123 (£2193)</td><td style="color:var(--green)">$49,476 (£26321)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Seaford+Victoria+Australia/@-38.1000,145.1340,13z" target="_blank" style="color:var(--accent)">Seaford 📍</a></td><td>$620 (£330)</td><td>$2,686 (£1429)</td><td style="color:var(--green)">$3,993 (£2124)</td><td style="color:var(--green)">$47,916 (£25491)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Frankston+Victoria+Australia/@-38.1430,145.1260,13z" target="_blank" style="color:var(--accent)">Frankston 📍</a></td><td>$630 (£335)</td><td>$2,730 (£1452)</td><td style="color:var(--green)">$3,949 (£2101)</td><td style="color:var(--green)">$47,388 (£25210)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Mordialloc+Victoria+Australia/@-37.9870,145.0870,13z" target="_blank" style="color:var(--accent)">Mordialloc 📍</a></td><td>$730 (£388)</td><td>$3,163 (£1683)</td><td style="color:var(--green)">$3,516 (£1871)</td><td style="color:var(--green)">$42,192 (£22446)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Mentone+Victoria+Australia/@-37.9830,145.0670,13z" target="_blank" style="color:var(--accent)">Mentone 📍</a></td><td>$800 (£426)</td><td>$3,466 (£1844)</td><td style="color:var(--green)">$3,213 (£1709)</td><td style="color:var(--green)">$38,556 (£20512)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Glen Waverley+Victoria+Australia/@-37.8780,145.1630,13z" target="_blank" style="color:var(--accent)">Glen Waverley 📍</a></td><td>$820 (£436)</td><td>$3,553 (£1890)</td><td style="color:var(--green)">$3,126 (£1663)</td><td style="color:var(--green)">$37,512 (£19956)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Sandringham+Victoria+Australia/@-37.9510,145.0100,13z" target="_blank" style="color:var(--accent)">Sandringham 📍</a></td><td>$950 (£505)</td><td>$4,116 (£2190)</td><td style="color:var(--orange)">$2,563 (£1364)</td><td style="color:var(--orange)">$30,756 (£16362)</td></tr><tr><td style="font-weight:600"><a href="https://www.google.com/maps/search/Brighton+Victoria+Australia/@-37.9070,144.9870,13z" target="_blank" style="color:var(--accent)">Brighton 📍</a></td><td>$1100 (£585)</td><td>$4,766 (£2536)</td><td style="color:var(--orange)">$1,913 (£1018)</td><td style="color:var(--orange)">$22,956 (£12213)</td></tr></table></div><p class="ts mt2">Includes: rent, groceries ($1,400 (£745)), car ($500 (£266)), utilities ($350 (£186)), health copay ($80 (£43)), phones ($130 (£69)), kids activities ($300 (£160)), UK costs net (-£37 surplus).</p></div>';

CMP.costs+='<div class="card"><h2>📊 Salary Breakdown — $159,00 (£8459)0 AUD</h2><div class="table-wrap"><table><tr><th></th><th>Amount</th></tr><tr><td>Gross salary</td><td>$159,000 (£84588)</td></tr><tr><td>Tax</td><td>-$40,972 (£21797)</td></tr><tr><td>Medicare levy (2%)</td><td>-$3,180 (£1692)</td></tr><tr style="font-weight:700"><td>Net annual</td><td>$114,848 (£61099)</td></tr><tr style="font-weight:700"><td>Net monthly</td><td>$9,571 (£5092)</td></tr><tr><td>Super (12% employer pays)</td><td>$19,080 (£10151)/yr (not in your pocket)</td></tr><tr><td>Health insurance (Amazon 80%)</td><td>Saves ~$350 (£186)/mo vs paying yourself</td></tr></table></div></div>';

CMP.costs+='<div class="card"><h2>🛒 Melbourne Living Costs — Real Prices</h2><p class="tx tm mb2">What things actually cost day-to-day. Prices in AUD.</p><h3>🛒 Groceries (Weekly Family Shop)</h3><div class="table-wrap"><table><tr><th>Item</th><th>Coles/Woolworths</th><th>Aldi (cheaper)</th></tr><tr><td>Milk 2L</td><td>$3.50 (£2)</td><td>$2.89 (£2)</td></tr><tr><td>Bread loaf</td><td>$3.5 (£2)0–5.00 (£2–3)</td><td>$2.49 (£1)</td></tr><tr><td>Chicken breast 1kg</td><td>$1 (£1)2–14 (£6–7)</td><td>$1 (£1)0–11 (£5–6)</td></tr><tr><td>Mince beef 500g</td><td>$7–9 (£4–5)</td><td>$5.99 (£3)</td></tr><tr><td>Rice 1kg</td><td>$3–4 (£2–2)</td><td>$2.49 (£1)</td></tr><tr><td>Eggs 12</td><td>$5–7 (£3–4)</td><td>$4.49 (£2)</td></tr><tr><td>Bananas 1kg</td><td>$3–5 (£2–3)</td><td>$2.99 (£2)</td></tr><tr><td>Pasta 500g</td><td>$2–3 (£1–2)</td><td>$1.29 (£1)</td></tr><tr><td>Cheese block 500g</td><td>$6–8 (£3–4)</td><td>$4.99 (£3)</td></tr><tr><td>Cereal box</td><td>$5–7 (£3–4)</td><td>$3.49 (£2)</td></tr><tr style="font-weight:700"><td>Typical weekly shop (family 4)</td><td>$28 (£15)0–350 (£149–186)</td><td>$20 (£11)0–260 (£106–138)</td></tr></table></div>';

CMP.costs+='<h3>☕ Eating Out & Coffees</h3><div class="table-wrap"><table><tr><th>Item</th><th>Typical Cost</th></tr><tr><td>Coffee (flat white/latte)</td><td>$4.5 (£2)0–6.00 (£2–3)</td></tr><tr><td>Bubble tea</td><td>$6–8 (£3–4)</td></tr><tr><td>Lunch (cafe/takeaway)</td><td>$1 (£1)5–22 (£8–12)</td></tr><tr><td>Dinner out (family of 4, casual)</td><td>$8 (£4)0–120 (£43–64)</td></tr><tr><td>Dinner out (family of 4, nice restaurant)</td><td>$15 (£8)0–250 (£80–133)</td></tr><tr><td>Pizza delivery (family)</td><td>$4 (£2)0–60 (£21–32)</td></tr><tr><td>Fish & chips (family)</td><td>$3 (£2)5–50 (£19–27)</td></tr><tr><td>Pub meal (adult)</td><td>$2 (£1)2–35 (£12–19)</td></tr><tr><td>Kids meal (pub/cafe)</td><td>$1 (£1)0–15 (£5–8)</td></tr><tr><td>Ice cream (scoop)</td><td>$5–7 (£3–4)</td></tr></table></div>';

CMP.costs+='<h3>⚽ Kids Activities & Entertainment</h3><div class="table-wrap"><table><tr><th>Activity</th><th>Cost</th></tr><tr><td>Cinema (adult)</td><td>$2 (£1)0–24 (£11–13)</td></tr><tr><td>Cinema (child)</td><td>$1 (£1)5–18 (£8–10)</td></tr><tr><td>Bounce Inc / trampoline park (per child)</td><td>$2 (£1)0–30 (£11–16)/session</td></tr><tr><td>Ice skating session</td><td>$1 (£1)8–25 (£10–13) inc skate hire</td></tr><tr><td>Bowling (per person)</td><td>$1 (£1)5–20 (£8–11)</td></tr><tr><td>Mini golf</td><td>$1 (£1)5–18 (£8–10)</td></tr><tr><td>Zoo (Melbourne Zoo family)</td><td>$8 (£4)0–100 (£43–53)</td></tr><tr><td>Aquarium (SEA LIFE family)</td><td>$9 (£5)0–120 (£48–64)</td></tr><tr><td>Swimming pool entry</td><td>$5–8 (£3–4)</td></tr><tr><td>Beach</td><td>FREE</td></tr><tr><td>Parks / playgrounds</td><td>FREE</td></tr><tr><td>BBQ areas (public)</td><td>FREE</td></tr><tr><td>Bike trails</td><td>FREE</td></tr><tr><td>Library</td><td>FREE</td></tr><tr><td>Sport club registration (per term)</td><td>$10 (£5)0–250 (£53–133)</td></tr><tr><td>Circus/aerial class (per term)</td><td>$25 (£13)0–450 (£133–239)</td></tr><tr><td>Ice hockey (per season)</td><td>$50 (£27)0–800 (£266–426)</td></tr></table></div>';

CMP.costs+='<h3>🚗 Transport & Car</h3><div class="table-wrap"><table><tr><th>Item</th><th>Cost</th></tr><tr><td>Petrol (per litre)</td><td>$1.7 (£1)0–2.10 (£1–1)</td></tr><tr><td>Full tank (60L)</td><td>$10 (£5)0–125 (£53–66)</td></tr><tr><td>Myki (train/tram weekly cap)</td><td>$53 (£28)</td></tr><tr><td>Car rego (annual)</td><td>$35 (£19)0–850 (£186–452)</td></tr><tr><td>Car insurance (comprehensive, annual)</td><td>$1,20 (£64)0–2,400 (£638–1277)</td></tr><tr><td>RACV roadside (annual)</td><td>$10 (£5)0–150 (£53–80)</td></tr><tr><td>Car service</td><td>$20 (£11)0–400 (£106–213)</td></tr><tr><td>Tyres (set of 4)</td><td>$40 (£21)0–800 (£213–426)</td></tr></table></div>';

CMP.costs+='<h3>🏠 Household & Utilities</h3><div class="table-wrap"><table><tr><th>Item</th><th>Monthly Cost</th></tr><tr><td>Electricity + gas</td><td>$20 (£11)0–350 (£106–186)</td></tr><tr><td>Water</td><td>$5 (£3)0–80 (£27–43) (often in rent)</td></tr><tr><td>Internet (NBN 50-100Mbps)</td><td>$7 (£4)0–90 (£37–48)</td></tr><tr><td>Mobile plan (per person)</td><td>$3 (£2)0–50 (£16–27)</td></tr><tr><td>Netflix</td><td>$1 (£1)7–23 (£9–12)</td></tr><tr><td>Spotify</td><td>$1 (£1)2–19 (£6–10) (family)</td></tr><tr><td>Contents insurance</td><td>$3 (£2)0–60 (£16–32)</td></tr><tr><td>Haircut (mens)</td><td>$2 (£1)5–40 (£13–21)</td></tr><tr><td>Haircut (womens)</td><td>$6 (£3)0–120 (£32–64)</td></tr><tr><td>Gym membership</td><td>$5 (£3)0–80 (£27–43)</td></tr></table></div>';

CMP.costs+='<h3>🎉 Weekend / Family Outings</h3><div class="table-wrap"><table><tr><th>Activity</th><th>Typical Cost (family 4)</th></tr><tr><td>Beach day (parking + ice cream)</td><td>$2 (£1)0–30 (£11–16)</td></tr><tr><td>Phillip Island Penguin Parade</td><td>$12 (£6)0–160 (£64–85)</td></tr><tr><td>Great Ocean Road day trip (fuel + lunch)</td><td>$8 (£4)0–120 (£43–64)</td></tr><tr><td>Healesville Sanctuary</td><td>$8 (£4)0–100 (£43–53)</td></tr><tr><td>Melbourne Museum</td><td>$0–30 (£0–16) (kids free)</td></tr><tr><td>Queen Vic Market shop + lunch</td><td>$5 (£3)0–80 (£27–43)</td></tr><tr><td>Mornington Peninsula hot springs</td><td>$12 (£6)0–180 (£64–96)</td></tr><tr><td>Camping weekend (fuel + food + site)</td><td>$10 (£5)0–200 (£53–106)</td></tr><tr><td>AFL game (4 tickets)</td><td>$8 (£4)0–160 (£43–85)</td></tr></table></div>';
...
CMP.costs+='<div class="card"><h2>🚗 Car: Lease vs Buy</h2><div class="table-wrap"><table><tr><th></th><th>Cheap Lease (12 months)</th><th>Buy Used (outright)</th><th>Buy Used (finance)</th></tr><tr><td style="font-weight:600">Upfront cost</td><td>$0–$1,000 (£532) deposit</td><td>$12,00 (£638)0–$18,000 (£9576)</td><td>$2,00 (£106)0–$3,000 (£1596) deposit</td></tr><tr><td style="font-weight:600">Monthly cost</td><td>$40 (£21)0–$550 (£293)/mo</td><td>$0 (you own it)</td><td>$30 (£16)0–$450 (£239)/mo</td></tr><tr><td style="font-weight:600">Annual total</td><td>$4,80 (£255)0–$6,600 (£3511)</td><td>$0 (after purchase)</td><td>$3,60 (£192)0–$5,400 (£2873)</td></tr><tr><td style="font-weight:600">Insurance</td><td>Often included</td><td>You pay (~$150 (£80)/mo)</td><td>You pay (~$150 (£80)/mo)</td></tr><tr><td style="font-weight:600">Rego + maintenance</td><td>Often included</td><td>You pay (~$80 (£43)/mo)</td><td>You pay (~$80 (£43)/mo)</td></tr><tr><td style="font-weight:600">Flexibility</td><td style="color:var(--green)">Return after 12 months</td><td>Sell when you want</td><td>Locked into finance term</td></tr><tr><td style="font-weight:600">Credit needed?</td><td style="color:var(--red)">Yes — hard with no AU credit history</td><td style="color:var(--green)">No</td><td style="color:var(--red)">Yes — hard with no AU credit history</td></tr><tr style="font-weight:700"><td>Best for you?</td><td>Good if you can get approved</td><td style="color:var(--green)">RECOMMENDED — no credit needed, cheapest long-term</td><td>Unlikely to get approved initially</td></tr></table></div><p class="ts mt2">⚠️ <strong>Credit history:</strong> You arrive with ZERO Australian credit score. Leases and finance are hard to get in the first 6–12 months. Buying outright with cash is the safest option. Budget $1 (£1)2–18 (£6–10)k from relocation cash or savings.</p><p class="ts mt2">💡 <strong>Novated lease through Amazon:</strong> Ask your employer — a novated lease uses your salary (pre-tax) so credit score matters less. Could save tax too. Discuss with your tax advisor.</p></div>';
