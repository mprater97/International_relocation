...
function renderSuburbsInteractive(){
  ...
  tiers.forEach(function(tier){
    ...
    tier.suburbs.forEach(function(sname){
      ...
      // Photo link
      html+='<div style="margin-top:8px"><a href="https://www.google.com/maps/search/'+s.name.replace(/ /g,'+')+'+Victoria+Australia/@'+s.lat+','+s.lng+',14z/data=!3m1!1e3" target="_blank" style="font-size:.75rem;color:var(--accent)">📷 View photos on Google Maps</a></div>';
      // Quick stats row
